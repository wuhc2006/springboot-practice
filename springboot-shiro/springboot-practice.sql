...
CREATE TABLE `t_supplier` (
                              ...
                              `delivery_fee` decimal(6,2) DEFAULT NULL COMMENT '配送费用',
                              `delivery_amount` decimal(6,2) DEFAULT NULL COMMENT '起送金额',
                              `delivery_service` varchar(100) DEFAULT NULL COMMENT '配送服务类型',
...
-- ----------------------------
INSERT INTO `t_supplier` VALUES ('1', '饿了么', 'whc', '123456789', '深圳市', '2.50', '20.00', '外卖', '2km以内', '2', '2019-08-17 16:58:59', null);
INSERT INTO `t_supplier` VALUES ('2', '美团', 'sda', '123424234234', '广州市', '2.00', '30.00', 'adsf', 'asdf', '2', '2019-08-24 17:19:21', '2019-08-24 09:09:16');
INSERT INTO `t_supplier` VALUES ('3', 'ad', 'ad', 'ad', 'sdff', '2.00', '20.00', '外卖', '2km', '2', '2019-08-28 17:19:24', '2019-08-24 09:09:07');
